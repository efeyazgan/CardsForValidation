...
#process.load('TopMonteCarlo.Configuration.Hadronizer_pythia8_Powheg_TuneCP4_NNPDF31_cff')
#process.load('Configuration.Generator.Hadronizer_pythia8_Powheg_TuneCP4_NNPDF31_cff')
#process.load('Configuration.Generator.Hadronizer_pythia8_Powheg_TuneCP4_NNPDF31__MPI_LO_RUNNING_cff')
process.load('Configuration.Generator.Hadronizer_pythia8_Powheg_TuneCP5_NNPDF31_cff')
...
#    args = cms.vstring('../TT_hdamp_TuneT4_NNPDF31_NNLO_13TeV_powheg_hvq.tgz'),
    args = cms.vstring('/afs/cern.ch/user/e/efe/workspace_afs/CMSSW_9_2_6_patch1/src/TT_hdamp1p372mtop_TuneT4_NNPDF31_NNLO_13TeV_hvq.tgz'),
...
#    annotation = cms.untracked.string('Configuration/GenProduction/python/POWHEGsamePDF.py nevts:5000'),
