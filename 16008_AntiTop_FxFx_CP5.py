...
options.register('nevents', 200, VarParsing.VarParsing.multiplicity.singleton,VarParsing.VarParsing.varType.int, "Number of events")
...
#    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/8TeV/powheg/V2/TT_hdamp_TuneT4_NNPDF31/TT_hdamp_TuneT4_NNPDF31.tgz'),
    args = cms.vstring('/afs/cern.ch/user/e/efe/workspace_afs/CMSSW_9_2_6_patch1/src/tt012j_1l_tbar_5f_ckm_NLO_FXFX_NNPDF31_NNLO_tarball.tar.xz'),
